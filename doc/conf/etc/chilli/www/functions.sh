...
CHILLI_RESPONSE=/opt/chilli/sbin/chilli_response
CHILLI_QUERY=/opt/chilli/sbin/chilli_query
CHILLI_PROXY=/opt/chilli/sbin/chilli_proxy

# default, after configuration

pkg_attr_file() {
    p=/opt/chilli/etc/chilli/pkg.
    while [ "$1" != "" ]; do
